                ...
                <div class="sidemenu-container navbar-collapse collapse fixed-menu">
                    <div id="remove-scroll" class="left-sidemenu">
                        <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
                            ...
                            <li class="nav-item">
                                <a href="{{route('PetProduct')}}" class="nav-link nav-toggle"> <i data-feather="calendar"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{route('AdoptionList')}}" class="nav-link nav-toggle"> <i data-feather="calendar"></i>
                                    <span class="title">Adoption List</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('Customer')}}" class="nav-link nav-toggle"> <i data-feather="calendar"></i>
