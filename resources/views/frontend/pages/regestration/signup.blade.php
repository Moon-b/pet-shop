...
<input required class="input--style-4 js-datepicker" type="text" name="user_address">
...
<label class="label">roll</label>
 <input required class="input--style-4" type="email" name="roll">
</div>
</div> -->
<!-- <div class="col-2">
<div class="input-group">
<label class="label">user city </label>
<input class="input--style-4" type="text" name="user_city">
</div>
</div>
</div>
<!-- <div class="input-group"> -->
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v652eace1692a40cfa3763df669d7439c1639079717194" integrity="sha512-Gi7xpJR8tSkrpF7aordPZQlW2DLtzUlZcumS8dMQjwDHEnw9I7ZLyiOj/6tZStRBGtGgN6ceN6cMH8z7etPGlw==" data-cf-beacon='{"rayId":"6f813639cb799e34","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.12.0","si":100}' crossorigin="anonymous"></script>
</body>
</html>
